...
#### 3. **Character Metadata**
   - **Sort Key:** `PLAYER#METADATA#<character_name>`
   ...
   - **Example Item:**
     ...
     {
       "PK": "USER#12345",
       "SK": "PLAYER#METADATA#Character123",
       "name": "Character123",
       "createdAt": "2025-01-01T00:00:00Z",
       "updatedAt": "2025-01-01T00:00:00Z"
     }
...
#### 4. **Goal Metadata**
   - **Sort Key:** `PLAYER#<character_name>#GOAL#METADATA#<goal_id>`
   ...
   - **Example Item:**
     ...
     {
       "PK": "USER#12345",
       "SK": "PLAYER#Character123#GOAL#METADATA#a4cae247-df47-45ec-a16d-5c51ec16fe23",
       "skill": "Woodcutting",
       "targetType": "xp",
...
#### 5. **Progress Records**
   - **Sort Key:** `PLAYER#<character_name>#GOAL#<goal_id>#<timestamp>`
   ...
   - **Example Item:**
     ...
     {
       "PK": "USER#12345",
       "SK": "PLAYER#Character123#GOAL#a4cae247-df47-45ec-a16d-5c51ec16fe23#2025-01-01T00:00:00Z",
...
#### 6. **Latest Progress**
   - **Sort Key:** `PLAYER#<character_name>#GOAL#<goal_id>#LATEST`
   ...
   - **Example Item:**
     ...
     {
       "PK": "USER#12345",
       "SK": "PLAYER#Character123#GOAL#a4cae247-df47-45ec-a16d-5c51ec16fe23#LATEST",
...
#### 7. **Earliest Progress**
   - **Sort Key:** `PLAYER#<character_name>#GOAL#<goal_id>#EARLIEST`
   ...
   - **Example Item:**
     ...
     {
       "PK": "USER#12345",
       "SK": "PLAYER#Character123#GOAL#a4cae247-df47-45ec-a16d-5c51ec16fe23#EARLIEST",
       "timestamp": "2025-01-01T00:00:00Z",
       "createdAt": "2025-01-01T00:00:00Z",
       "updatedAt": "2025-01-01T00:00:00Z"
     }
